...
public class UpdateCompanyValidator: AbstractValidator<UpdateCompanyRequestDTO>
{
    public UpdateCompanyValidator() {
        RuleFor(company => company.Id).NotNull().WithMessage("A propriedade Id é obrigatória")
          .NotEmpty().WithMessage("A propriedade Id não pode estar em branco.");
